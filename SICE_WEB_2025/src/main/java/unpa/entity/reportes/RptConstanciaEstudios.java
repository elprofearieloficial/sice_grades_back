...
public class RptConstanciaEstudios extends Reporte {
    ...
    public JasperPrint generateJasperPrintConstanciaConHistorial(InputStream jasperStream, UniversidadProjection universidad, CampusProjection campus, AlumnoConstanciaDTO alumno, ReinscripcionPeriodoProjection reinscripcionPeriodoProjection, PeriodoEscolar periodoInicial, PeriodoEscolar periodoFinal) {
        try {
